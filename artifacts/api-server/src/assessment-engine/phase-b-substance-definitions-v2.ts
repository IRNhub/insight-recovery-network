...
const PENDING_PHASE_B_APPROVAL: ClinicalApprovalMetadata = {
  status: "pending-clinical-director",
  reference: "IRN-ASSESSMENT-PHASE-B-SUBSTANCE-RULES-V2",
  notes: "Synthetic implementation fixture. Questionnaire wording, mappings, actions and pathways require Clinical Director approval before production activation.",
};
    ...
    },
    {
      ...
      questions: [
        radio("alcohol-current-withdrawal", "Are you currently experiencing symptoms after reducing, stopping or delaying alcohol?", [
          ...
          option("severe", "Severe or rapidly worsening symptoms", 6),
        ]),
  ...
  return [
    {
      ...
      questions: [
        ...
        radio("substance-alcohol-withdrawal", "Are you currently experiencing alcohol-withdrawal symptoms?", [option("none", "No"), option("mild", "Mild symptoms", 2), option("significant", "Significant symptoms", 4), option("severe", "Severe or rapidly worsening symptoms", 6)]),
...
function safetyRule(rule: Omit<SafetyRule, "version" | "approval">): SafetyRule {
  return { ...rule, version: 2, approval: PENDING_PHASE_B_APPROVAL };
}
...
function alcoholSafetyRules(key: "alcohol-use" | "alcohol-detox"): SafetyRule[] {
  return [
    ...
    safetyRule({ id: `alcohol.current-severe.${key}.v2`, action: "emergency-help-now", all: [{ questionId: "alcohol-current-withdrawal", equals: "severe" }], evidenceQuestionIds: ["alcohol-current-withdrawal"], contentId: "alcohol-withdrawal-emergency", pathwayIds: ["emergency-999"], suppressCommercialCtas: true }),
    ...
    safetyRule({ id: `alcohol.abrupt-with-tolerance.${key}.v2`, action: "clinical-review-recommended", all: [{ questionId: "alcohol-intended-change", equals: "abrupt" }, { questionId: "alcohol-tolerance", oneOf: ["possibly", "yes"] }], evidenceQuestionIds: ["alcohol-intended-change", "alcohol-tolerance"], contentId: "alcohol-withdrawal-review", pathwayIds: ["detox-clinical-review"], suppressCommercialCtas: false }),
    ...
    safetyRule({ id: `alcohol.opioid-couse.${key}.v2`, action: "clinical-review-recommended", all: [{ questionId: "alcohol-co-use", includes: "opioids" }], evidenceQuestionIds: ["alcohol-co-use"], contentId: "opioid-overdose-caution", pathwayIds: ["nhs-substance-service"], suppressCommercialCtas: false }),
    safetyRule({ id: `pregnancy.${key}.v2`, action: "clinical-review-recommended", all: [{ questionId: "pregnancy", oneOf: ["yes", "possible"] }], evidenceQuestionIds: ["pregnancy"], contentId: "pregnancy-substance-review", pathwayIds: ["gp-review"], suppressCommercialCtas: false }),
...
function substanceSafetyRules(key: "drug-use" | "detox-suitability"): SafetyRule[] {
  return [
    ...
    safetyRule({ id: `alcohol.current-severe.${key}.v2`, action: "emergency-help-now", all: [{ questionId: "substance-alcohol-withdrawal", equals: "severe" }], evidenceQuestionIds: ["substance-alcohol-withdrawal", "substances"], contentId: "alcohol-withdrawal-emergency", pathwayIds: ["emergency-999"], suppressCommercialCtas: true }),
    ...
    ...(key === "detox-suitability" ? [
      ...
      safetyRule({ id: `benzodiazepine.global-abrupt.${key}.v2`, action: "clinical-review-recommended", all: [{ questionId: "intended-change", equals: "abrupt" }, { questionId: "substance-benz-frequency", oneOf: ["several-week", "daily", "multiple-daily"] }], evidenceQuestionIds: ["intended-change", "substance-benz-frequency"], contentId: "benzodiazepine-withdrawal-review", pathwayIds: ["detox-clinical-review"], suppressCommercialCtas: false }),
      safetyRule({ id: `ghb.global-abrupt.${key}.v2`, action: "clinical-review-recommended", all: [{ questionId: "intended-change", equals: "abrupt" }, { questionId: "substance-ghb-frequency", oneOf: ["most-days", "daily", "multiple-daily"] }], evidenceQuestionIds: ["intended-change", "substance-ghb-frequency"], contentId: "ghb-gbl-withdrawal-review", pathwayIds: ["detox-clinical-review"], suppressCommercialCtas: false }),
    ] : []),
    ...
    safetyRule({ id: `benzodiazepine.abrupt.${key}.v2`, action: "clinical-review-recommended", all: [{ questionId: "substance-benz-abrupt", equals: "yes" }, { questionId: "substance-benz-frequency", oneOf: ["daily", "multiple-daily"] }], evidenceQuestionIds: ["substance-benz-abrupt", "substance-benz-frequency"], contentId: "benzodiazepine-withdrawal-review", pathwayIds: ["detox-clinical-review"], suppressCommercialCtas: false }),
...
function interpretation(
  ...
  return { id, priority, domainIds, minimumState: "elevated", statement, whyItMatters, approval: PENDING_PHASE_B_APPROVAL };
}
...
function definitionBase(
  ...
  return {
    ...
    clinicalApproval: {
      ...PENDING_PHASE_B_APPROVAL,
      notes: `${PENDING_PHASE_B_APPROVAL.notes} ${key.startsWith("alcohol") ? INSTRUMENT_PERMISSION_DECISION.audit : INSTRUMENT_PERMISSION_DECISION.assist}`,
    },
  };
}
