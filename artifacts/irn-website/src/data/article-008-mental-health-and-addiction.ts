export const mentalHealthAndAddictionArticle = {
  slug: "mental-health-and-addiction",
  title: "Mental Health and Addiction: A Complete UK Guide",
  excerpt: "Understand how mental health and addiction interact, what a safe assessment covers, urgent warning signs and how to find coordinated UK support.",
  author: "Craig Bilton",
  ...
  ogImage: "/mental-health-and-addiction-uk-hero-og.webp",
  imageAlt: "Adult discussing mental health and addiction with two coordinated support practitioners.",
  seoTitle: "Mental Health and Addiction: UK Guide | IRN",
  metaDescription: "Understand how mental health and addiction interact, what a safe assessment covers, urgent warning signs and how to find coordinated UK support.",
  ogTitle: "Mental Health and Addiction: A Complete UK Guide",
  ogDescription: "Evidence-based guidance on co-occurring needs, assessment, integrated care, urgent risk and finding the right UK support.",
  publishedStatus: "published" as const,
  medicalWebPage: true,
  supportingImages: [
    {
      afterHeading: "What a comprehensive assessment should cover",
      src: "/co-occurring-needs-integrated-assessment.webp",
      alt: "Practitioner and client mapping mental health symptoms and substance use over time.",
      caption: "A careful assessment looks at timing and interaction: what happens before, during and after substance use, withdrawal, stress and changes in mental health.",
    },
    {
      afterHeading: "A practical first-week plan",
      src: "/mental-health-addiction-recovery-routine.webp",
      alt: "Adult building a stable weekly routine as part of mental health and addiction recovery.",
      caption: "Treatment is strengthened by practical foundations such as a safer environment, sleep, routine, relationships, physical healthcare and reliable follow-up.",
    },
  ],
  faq: [
    {
      question: "Can addiction cause mental-health problems?",
      answer: "Alcohol, drugs, addictive behaviours, intoxication, withdrawal and sleep disruption can cause or worsen mental-health symptoms. They may also occur alongside an independent condition or shared vulnerabilities. A clinician needs the history, timing, physical-health information and observation over time to assess the likely relationship.",
    },
    {
      question: "Should mental health or addiction be treated first?",
      answer: "There is no universal order. Immediate dangers such as overdose, severe withdrawal, suicidal intent or acute psychosis come first. Beyond that, current UK guidance supports a coordinated plan in which treatments may run together or in a deliberate sequence based on risk, diagnosis, engagement and clinical capability.",
    },
    {
      question: "Can a mental-health service refuse me because I use drugs or alcohol?",
      answer: "NICE says people with severe mental illness should not be excluded from appropriate mental-health care because of substance misuse, and people with psychosis should not be excluded from substance-misuse services because of that diagnosis. A service may refer or work jointly according to need, but blanket exclusion conflicts with the no wrong door principle.",
    },
    {
      question: "Do I need a dual-diagnosis rehab?",
      answer: "Not necessarily. Many people receive coordinated care in the community. Residential or inpatient care may be appropriate when withdrawal, psychiatric risk, repeated relapse, physical illness or an unsafe environment requires greater intensity. Check a provider's actual psychiatric, medical and crisis capability rather than relying on the label.",
    },
    {
      question: "Can I use NHS Talking Therapies if I have an addiction?",
      answer: "In England, people can self-refer for many anxiety and depression problems, but the service will assess suitability. Significant drug or alcohol problems or conditions needing specialist care may require a GP or specialist pathway. Drug or alcohol misuse should not be an automatic exclusion where the person can benefit and engage, but NHS Talking Therapies does not itself treat addiction.",
    },
    {
      question: "What should I do if substance use is making someone suicidal or psychotic?",
      answer: "Treat the risk as real regardless of the suspected cause. Call 999 or go to A&E if there is immediate danger, an attempt, severe confusion or inability to stay safe. For urgent mental-health help in England without immediate life-threatening danger, use NHS 111 online or call 111 and select the mental-health option. New psychosis needs prompt medical assessment.",
    },
  ],
  sources: [
    { title: "Adult substance misuse treatment statistics 2024 to 2025", publisher: "Office for Health Improvement and Disparities", url: "https://www.gov.uk/government/statistics/substance-misuse-treatment-for-adults-statistics-2024-to-2025/adult-substance-misuse-treatment-statistics-2024-to-2025-report" },
    { title: "Co-occurring mental health and substance use delivery framework", publisher: "Department of Health and Social Care and NHS England", url: "https://www.gov.uk/government/publications/co-occurring-mental-health-and-substance-use-delivery-framework/co-occurring-mental-health-and-substance-use-delivery-framework" },
    { title: "Clinical guidelines for alcohol treatment: people with co-occurring mental health conditions", publisher: "Department of Health and Social Care", url: "https://www.gov.uk/guidance/clinical-guidelines-for-alcohol-treatment/18-people-with-co-occurring-mental-health-conditions" },
    ...
    { title: "Coexisting severe mental illness and substance misuse: community health and social care services (NG58)", publisher: "NICE", url: "https://www.nice.org.uk/guidance/ng58/chapter/recommendations" },
    { title: "Coexisting severe mental illness (psychosis) and substance misuse (CG120)", publisher: "NICE", url: "https://www.nice.org.uk/guidance/cg120/chapter/Recommendations" },
    { title: "Drug misuse in over 16s: psychosocial interventions (CG51)", publisher: "NICE", url: "https://www.nice.org.uk/guidance/CG51/chapter/recommendations" },
    { title: "Drug misuse and dependence: UK guidelines on clinical management", publisher: "Department of Health", url: "https://www.gov.uk/government/publications/drug-misuse-and-dependence-uk-guidelines-on-clinical-management" },
    { title: "Mental health services and urgent help", publisher: "NHS", url: "https://www.nhs.uk/nhs-services/mental-health-services/" },
    { title: "Talking therapies", publisher: "NHS", url: "https://www.nhs.uk/tests-and-treatments/talking-therapies/" },
    { title: "Psychosis: overview", publisher: "NHS", url: "https://www.nhs.uk/mental-health/conditions/psychosis/overview/" },
  ],
  content: `Mental health difficulties and addiction often occur together, but the relationship is rarely simple. Alcohol, drugs or addictive behaviours may be used to manage distress; they can also trigger or worsen symptoms. Trauma, biology, relationships, housing, physical health and other pressures may affect both. Good care therefore considers the whole person, assesses immediate risks and coordinates evidence-based help instead of deciding that one problem must be solved before the other can be discussed.
...
- [What co-occurring needs means](#what-does-co-occurring-mental-health-and-addiction-mean)
- [How mental health and addiction interact](#how-mental-health-and-addiction-can-interact)
- [Common patterns](#common-mental-health-patterns-in-addiction-care)
- [When to get urgent help](#when-to-get-urgent-help)
- [What an assessment should cover](#what-a-comprehensive-assessment-should-cover)
- [What integrated treatment looks like](#what-good-integrated-care-looks-like)
- [How to find help in the UK](#how-to-find-help-in-the-uk)
- [A practical first-week plan](#a-practical-first-week-plan)
...
This broad guide focuses on recognising the interaction, preparing for assessment and finding coordinated help. For a closer look at service models and treatment planning, see our [dual-diagnosis guide](/resources/dual-diagnosis).
...
For a plain-language explanation of craving, relief and impaired control, read [Why Can't I Stop? How Addiction Works](/resources/why-cant-i-stop-how-addiction-works).
...
IRN's [anxiety screening assessment](/assessments/anxiety) can support reflection, but it is not diagnostic and is not suitable for an emergency.
...
The [depression screening assessment](/assessments/depression) may help someone organise their thoughts before speaking to a professional, but it cannot confirm depression.
...
Our [ADHD and impulsivity screening](/assessments/adhd-impulsivity) is an educational starting point only.
...
[CTA:/assessments:Explore the assessments]
...
Residential intensity does not prove psychiatric capability. Ask who completes mental-health assessment, which clinicians are available, how medicines are managed, what happens during crisis and whether the service coordinates with NHS or external psychiatric care. [Treatment placement](/treatment-placement) should be based on verified capability, not the phrase "dual diagnosis" in marketing.
...
IRN offers educational [addiction and mental-health assessments](/assessments), structured [online recovery support](/online-programme) for suitable medically stable adults, and [treatment-placement guidance](/treatment-placement) where detox, residential care or greater clinical intensity may be needed. We do not diagnose mental illness, prescribe medication or provide emergency crisis care. Where needs fall outside our scope, the responsible next step is referral or coordination with appropriate medical and mental-health services.

## Choosing coordinated support: questions to ask

Before committing to a programme or placement, ask:

1. Who assesses mental health, substance use, withdrawal, suicide risk and physical health?
2. Which practitioners are professionally registered, and who provides clinical oversight?
3. How do you distinguish an urgent psychiatric or medical need from something your service can support?
4. Will I receive one written care plan covering both sets of needs?
5. Who coordinates with my GP, prescriber, community mental-health team or addiction service?
6. How are prescribed medicines stored, reviewed and monitored?
7. What happens if I become suicidal, psychotic, manic, severely intoxicated or at risk of withdrawal?
8. Are treatments specific to my assessed condition, or is "dual diagnosis" only a marketing label?
9. How will family or carers be involved if I consent, and what support is available to them separately?
10. What is the aftercare plan, and how will risk be reviewed after discharge or relapse?
...
Support does not mean monitoring every action or becoming the care coordinator. Families need boundaries, accurate information and help for their own wellbeing. Our [complete family-support guide](/resources/addiction-support-for-families) explains safety, communication, confidentiality and support without taking responsibility for another adult's recovery.
...
The aim is not to find the perfect label before acting. It is to build a safe, evidence-based plan that reflects the whole person and is reviewed as the evidence becomes clearer.`.trim(),
};
