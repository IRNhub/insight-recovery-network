...
const legacyArticles: Article[] = [
  {
    ...
    image: "/uk-family-addiction-report-2026-early-findings.webp",
    imageAlt: "UK Family Addiction Report 2026 Early Findings cover from Insight Recovery Network",
...
Have you been affected by a family member’s addiction or compulsive behaviour? The [UK Family Addiction Impact Survey 2026](https://www.insightrecoverynetwork.com/research/family-addiction-impact-survey-2026) remains open. Responses are anonymous and will contribute to the final UK Family Addiction Report 2026.`,
  },
  {
    ...
    image: "/crypto-trading-addiction-hero.webp",
    imageAlt: "Person reflecting on cryptocurrency trading losses while viewing a market chart",
...
Insight Recovery Network is not a regulated healthcare provider, does not diagnose or prescribe, and is not an emergency or crisis service.`,
  ...
  },
  {
    ...
    excerpt: "An alcohol-specific guide to detox risk, residential treatment fees, programme length and alternatives to private alcohol rehab in the UK.",
    author: "Craig Bilton",
    authorRole: "Founder & Clinical Director",
    date: "2026-06-12",
    "updatedDate": "2026-07-13",
    ...
    metaDescription: "Private alcohol rehab costs in the UK, including detox risk, what quotes should include, programme length and alcohol-specific NHS, online and overseas options.",
    ogTitle: "Private Alcohol Rehab UK: Costs, Options and Alternatives",
    ogDescription: "An alcohol-specific guide to detox risk, residential treatment fees, programme length and alternatives to private alcohol rehab in the UK.",
    sources: [
      {
...
Insight Recovery Network provides assessment-led, confidential [rehab placement guidance](/treatment-placement) for individuals and families trying to compare treatment options. This may include NHS support, private rehab, online recovery support, [family intervention guidance](/what-we-offer), or treatment abroad. We explain any relevant provider or referral relationship before a decision is made.
...
Explore [Private Rehab UK](/private-rehab-uk), compare [residential and online alternatives](/private-rehab-alternative-uk), or read about our assessment-led [treatment placement service](/treatment-placement).
