      ...
      questions: [
        {
          ...
          required: true,
          options: [
            { value: "significantly", label: "Significantly — they are a major source of difficulty", score: 4 },
            { value: "moderately", label: "Moderately — they cause regular frustration", score: 3 },
            { value: "mildly", label: "Mildly — some interference but I manage", score: 2 },
            { value: "not-much", label: "Not much at all", score: 0 },
          ],
        },
        {
          id: "duration",
