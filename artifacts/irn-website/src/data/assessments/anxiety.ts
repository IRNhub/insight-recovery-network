      ...
      questions: [
        {
          ...
          required: true,
          options: [
            { value: "nearly-every-day", label: "Nearly every day", score: 6 },
            { value: "more-than-half", label: "More than half the days", score: 4 },
            { value: "several-days", label: "Several days", score: 2 },
        ...
        },
        {
          ...
          required: true,
          options: [
            { value: "nearly-every-day", label: "Nearly every day", score: 4 },
            { value: "more-than-half", label: "More than half the days", score: 3 },
            { value: "several-days", label: "Several days", score: 2 },
            { value: "not-at-all", label: "Not at all", score: 0 },
          ],
        },
      ...
      questions: [
        {
          ...
          required: true,
          options: [
            { value: "significantly", label: "Significantly — it regularly prevents me", score: 4 },
            { value: "moderately", label: "Moderately — it makes things harder", score: 3 },
            { value: "mildly", label: "Mildly — some interference", score: 2 },
            { value: "not-at-all", label: "Not at all", score: 0 },
          ],
        },
        {
          ...
          required: true,
          options: [
            { value: "significantly", label: "Significantly", score: 4 },
