...
export const routeParity = {
  ...
  "/get-help": {
    ...
    canonical: "/get-help",
    indexable: true,
    h1: "Let’s talk through your options.",
    heroIntro: "Ask about rehab, recovery support or someone you are worried about. Choose how you would like us to contact you. There is no obligation to proceed.",
    primaryCta: {
      href: "#book",
