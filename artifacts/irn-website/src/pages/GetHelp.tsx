...
/* ──────────────────────────────────────────────────────────────────────────
   PRICE ANCHOR: figures are stated deliberately so visitors who cannot invest
   self-select out before enquiring. Edit here if pricing changes.
   ────────────────────────────────────────────────────────────────────────── */
const PROGRAMME_PRICE = "£950 to £1,950 a month"; // online recovery programme range
...
const formSchema = z.object({
  ...
  readiness: z.enum(["ready-now", "within-month", "exploring"], {
...
const faqs = [
  ...
  },
  {
    ...
    a: "No. The call exists to help you understand the options and decide whether any of them are right for your family. You stay in control.",
  },
  {
    q: "What if my loved one refuses help?",
    a: "This is one of the most common things families ask about. We can talk through how to approach it calmly, without ultimatums or coercion.",
  },
  {
    q: "Do you only work with families in the UK?",
    a: "We are UK clinically led and work with families across the UK, with treatment options both in the UK and overseas.",
  },
];
...
function EnquiryForm() {
  ...
  async function onSubmit(data: FormValues) {
    ...
    try {
      ...
      const readinessLabel = READINESS_LABEL[data.readiness] ?? data.readiness;
      const composedMessage =
        `Recovery support readiness: ${readinessLabel}.` +
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5">
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel className="text-primary font-medium">
                  Are you in a position to invest in private recovery support now?
                </FormLabel>
                <Select onValueChange={field.onChange} defaultValue={field.value}>
                  ...
                  <SelectContent className="rounded-none">
                    <SelectItem value="ready-now">Yes, ready now</SelectItem>
          ...
          <Button
            ...
            disabled={isPending}
          >
            {isPending ? "Sending…" : "Book a confidential call"}
          </Button>
          <p className="text-xs text-muted-foreground/70 text-center">
            Private and confidential. We usually respond the same day.
          </p>
        </form>
      </Form>
    </div>
...
export default function GetHelp() {
  return (
    <div className="min-h-[100dvh] flex flex-col bg-background text-foreground font-sans">
      <SEO
        title="Help for Families Facing Addiction"
        fullTitle="Help for Families Facing a Loved One's Addiction | Insight Recovery Network"
        description="Clinically led, confidential guidance for families weighing private recovery support, in the UK or overseas. Book a confidential call with Insight Recovery Network."
        canonical="/get-help"
          ...
          <div className="container mx-auto px-6 md:px-12 py-12 md:py-16">
            <div className="max-w-2xl">
              <p className="text-[11px] font-semibold tracking-[0.22em] uppercase text-accent/90 mb-5">
                For families facing a loved one's addiction
              </p>
              <h1 className="font-serif text-4xl md:text-5xl lg:text-6xl font-medium leading-[1.08] tracking-tight text-white mb-6">
                Loving someone through addiction is exhausting.
              </h1>
              <p className="text-lg md:text-xl text-white/85 font-light leading-relaxed mb-9 max-w-xl">
                You do not have to wait for a crisis, and you are not to blame. Speak confidentially
                with someone who has spent twenty years helping families find a way through.
              </p>
              <a
                href="#book"
          ...
          <div className="container mx-auto px-6 md:px-12">
            <div className="max-w-2xl">
              <p className="text-muted-foreground text-lg leading-relaxed mb-6">
                If you are reading this late at night, after another difficult evening, you already
                know how this feels. The walking on eggshells. The promises made and broken. The hope
                that lifts and then falls again.
              </p>
              <p className="text-muted-foreground text-lg leading-relaxed">
                None of this is your fault. You did not cause it, and you cannot control it on your
                own. You also do not have to wait until things get worse before you act. Reaching out
                early is not an overreaction. It is often the most useful thing a family can do.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-6 md:px-12">
            <div className="max-w-2xl">
              ...
              <p className="text-muted-foreground text-lg leading-relaxed mb-5">
                Private recovery support is an investment in getting real help, not a cost to
                apologise for. The online recovery programme runs from{" "}
                <span className="text-primary font-medium">{PROGRAMME_PRICE}</span>, depending on the
                level of support.
              </p>
              <p className="text-muted-foreground text-lg leading-relaxed mb-5">
                Treatment placement abroad covers a wide range. Longer-term options start from around{" "}
                <span className="text-primary font-medium">{PLACEMENT_FROM}</span>, while standard
                28-day residential programmes run from around{" "}
                <span className="text-primary font-medium">{PLACEMENT_28DAY}</span>, depending on the
                country, facility and length of stay.
              </p>
              <p className="text-muted-foreground leading-relaxed mb-8">
                If that is not something you are in a position to consider right now, that is
                completely understandable, and this may simply not be the right moment to enquire. If
                it is, a short conversation will help you understand exactly what your family needs.
              </p>
              <a
                href="#book"
                className="inline-flex items-center justify-center h-14 px-9 bg-primary text-primary-foreground text-base font-medium hover:bg-primary/90 transition-colors"
          ...
          <div className="container mx-auto px-6 md:px-12">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-start">
              <div className="lg:col-span-5">
                <h2 className="font-serif text-3xl md:text-4xl font-medium leading-tight text-primary mb-5">
                  Book a confidential call with Craig
                </h2>
                <p className="text-muted-foreground leading-relaxed mb-6">
                  Tell us a little about your situation and the best way to reach you. Your enquiry is
                  private, with no pressure and no obligation. We usually respond the same day.
                </p>
          ...
          <div className="container mx-auto px-6 md:px-12">
            <div className="max-w-2xl">
              ...
              <div className="space-y-5 text-white/85 text-lg leading-relaxed font-light">
                ...
                <p>
                  I know what families carry, because I have been on both sides of it. When we speak,
                  you will get an honest, clinical view of your situation and the realistic options,
                  with no shame and no pressure.
                </p>
              </div>
            </div>
          </div>
