...
import type { AssessmentAnswers, ScoreResult } from "@/types/assessment";
...
export default function AlcoholDetoxAssessment() {
  ...
  async function handleComplete(answers: AssessmentAnswers, score: ScoreResult, consent: boolean) {
    ...
    const sectionSummary = buildSectionSummary(alcoholDetoxAssessment, answers);
      ...
      <section className="py-16 md:py-20 border-t border-border/30" style={{ background: "#F6F4F0" }}>
        <div className="container mx-auto px-6 md:px-12 max-w-2xl">
          ...
          <p className="text-xs text-muted-foreground font-light mt-6 leading-relaxed">
            After your score is calculated, Anchor — our AI-assisted recovery guidance system — will generate a personalised reflection. Anchor does not diagnose or give medical instructions.
          </p>
        </div>
      </section>
    </Layout>
